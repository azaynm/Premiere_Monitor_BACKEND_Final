package com.MSMSPerformanceMonitor.realtime_backup.model;
...
public class SMSRealtimeQueueBackupModel {
	...
	public SMSRealtimeQueueBackupModel() {

	}

	public SMSRealtimeQueueBackupModel(Long autoindexId, String receiverMob, String dialogId, String sender, String numtype,
