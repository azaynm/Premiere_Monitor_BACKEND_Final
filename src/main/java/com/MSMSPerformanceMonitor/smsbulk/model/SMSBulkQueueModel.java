...
public class SMSBulkQueueModel {
	...
	public SMSBulkQueueModel() {
	
	}


	public SMSBulkQueueModel(Long autoindexId, String receiverMob, String status, String queuedTime, String imsiNo,
