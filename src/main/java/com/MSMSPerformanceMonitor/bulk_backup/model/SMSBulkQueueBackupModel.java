package com.MSMSPerformanceMonitor.bulk_backup.model;
...
public class SMSBulkQueueBackupModel {
	...
	public SMSBulkQueueBackupModel() {
	
	}


	public SMSBulkQueueBackupModel(Long autoindexId, String receiverMob, String status, String queuedTime, String imsiNo,
			String mscNo, String addedTime, String smsTime, Integer profile, Integer retryTime,
